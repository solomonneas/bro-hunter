    ...
    <div className={`space-y-2 ${className}`}>
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          Filters
          {hasActiveFilters && (
            <span className="w-4 h-4 rounded-full bg-accent-cyan text-background text-[10px] flex items-center justify-center font-bold">
      ...
      {/* Expanded filters */}
      {expanded && (
        <div className="p-3 rounded-lg border border-gray-700/50 bg-surface/50 space-y-3">
          {/* Severity toggles */}
          {showSeverity && (
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                {SEVERITIES.map((sev) => {
                  ...
                  return (
                    ...
                    >
                      <span className={`w-2 h-2 rounded-full ${sev.color} ${active ? 'opacity-100' : 'opacity-40'}`} />
                      {sev.label}
                    </button>
                  );
                })}
